 ...
 *
 ******************************************************************************/
package me.yuanhu.core.DataStructure.tree.b;
...
public class BTree<Key extends Comparable<Key>, Value>  {
    ...
    private Node root;       // root of the B-tree    // B-tree 的根节点
    private int height;      // height of the B-tree  // B-tree 的高度
    private int n;           // number of key-value pairs in the B-tree   //  B-tree 树中键值对的数目

    // helper B-tree node data type   // B-tree 节点类型
    ...
    private Node insert(Node h, Key key, Value val, int ht) {
        ...
        // 节点内部数组操作
        // external node 外部结点，也是叶子结点，在树的最底层，存的是内容value
        if (ht == 0) {
            for (j = 0; j < h.m; j++) {
