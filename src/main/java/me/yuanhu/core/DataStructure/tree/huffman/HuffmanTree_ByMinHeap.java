package me.yuanhu.core.DataStructure.tree.huffman;
 ...
 */
public class HuffmanTree_ByMinHeap {
     ...
     * @param 权值数组
     */
    public HuffmanTree_ByMinHeap(int a[]) {
        HuffmanNode parent = null;
        HuffmanMinHeap heap;

        // 建立数组a对应的最小堆
        heap = new HuffmanMinHeap(a);
    ...
    private static class HuffmanMinHeap {
         ...
         *     a -- 数据所在的数组
         */
        protected HuffmanMinHeap(int a[]) {
    ...
    public static void main(String[] args) {
        ...
        // 创建数组a对应的Huffman树
        tree = new HuffmanTree_ByMinHeap(a);
